...
// test #1 begin
	TEST_ALU ( 1,  3, 0, 0, 2); // (A,B,AINV,BNEG,Opr)  ADD
// test #1 end

// test #2 begin
	TEST_ALU ( 14, 12, 0, 0, 2); // (A,B,AINV,BNEG,Opr)  ADD
// test #2 end

// test #3 begin
	TEST_ALU ( 7, 5, 0, 0, 2); // (A,B,AINV,BNEG,Opr)  ADD
// test #3 end

// test #4 begin
	TEST_ALU ( 11, 9, 0, 0, 2); // (A,B,AINV,BNEG,Opr)  ADD
// test #4 end

// test #5 begin
	TEST_ALU ( 3, 1, 0, 1, 2); // (A,B,AINV,BNEG,Opr)  SUB
// test #5 end

// test #6 begin
	TEST_ALU ( 1, 3, 0, 1, 2); // (A,B,AINV,BNEG,Opr)  SUB
// test #6 end
...
// test #8 begin
	TEST_ALU ( 6, 10, 0, 1, 2); // (A,B,AINV,BNEG,Opr)  SUB
// test #8 end
